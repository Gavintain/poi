...
class Ui_MainWindow(object):
    ...
    def load_excel(self):
        ...
        if file_name:
            try:
                ...
                # 폰트 설정
                font = QtGui.QFont()
                font.setPointSize(12)  # 폰트 크기 설정 (예: 14)
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1045, 843)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(0, 10, 881, 791))
        font = QtGui.QFont()
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 0, 681, 751))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.pushButton_8 = QtWidgets.QPushButton(self.tab_1)
        self.pushButton_8.setGeometry(QtCore.QRect(710, 20, 151, 121))
